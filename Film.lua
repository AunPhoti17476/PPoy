...
if game.CoreGui:FindFirstChild("     ") then
    game.CoreGui:FindFirstChild("     "):Destroy()
end
filename="Edog_Hub.json"
function loadcheck()
    if isfile(filename) then
        else
            writefile(filename,game:GetService("HttpService"):JSONEncode(_G.Settings))
        return
    end
end
pcall(function()
	_G.Settings = {
		...
		Auto_Sharkman_Karata=false,
		Auto_Pirates_Raid=false,
		Select_Boss={},
		Auto_Farm_Boss=false,
		Auto_Farm_Boss_Hop=false,
		Auto_Farm_Mastery_Gun=false,
		Auto_Farm_Mastery_DF=false,
		Skill_Z=true,
		Skill_X=true,
		Skill_C=true,
		Skill_V=true,
		...
		Y_At=25,
		Z_At=25,
		Auto_Farm_Observation=false,
		Auto_Farm_Observation_Hop=false,
...
local function CheckQuest()
	...
	if World3 then
		...
		elseif MyLevel >= 2400 then
            ...
            CFrameMon = CFrame.new(-1299.1702880859375, 67.6225814819336, -14238.2890625)
            VectorMon = CFrame.new(-1299.1702880859375, 67.6225814819336, -14238.2890625)

            CFrameQuest = CFrame.new(-1147.741455078125, 14.133035659790039, -14444.5986328125)
            VectorQuest = Vector3.new(-1147.741455078125, 14.133035659790039, -14444.5986328125)
		end
	end
end
function Hop()
...
spawn(function()
	pcall(function()
		game:GetService("RunService").Stepped:Connect(function()
		  	if _G.Settings.Auto_Farm_Level or _G.Settings.Auto_Farm_Material or Noclip or _G.Settings.Auto_Farm_Ectoplasm or _G.Settings.Auto_Factory_Farm or _G.Settings.Auto_Elite_Hunter or _G.Settings.Auto_Holy_Torch or _G.Settings.Auto_Farm_Bones or _G.Settings.Auto_Farm_Observation or _G.Settings.Auto_Soul_Guitar or _G.Settings.Auto_Farm_Mastery_DF or _G.Settings.Auto_Farm_Mastery_Gun then
...
local PepsiUi=library:CreateWindow({Name="AUNTER HUB PREMIUM SCRIPTS",Themeable={Info="Discord Server: discord.gg/UAqpMW8J"}});
local Genaral = PepsiUi:CreateTab({Name = "Genaral"})
local ISLAND = PepsiUi:CreateTab({Name = "IsLand"})
local A = Genaral:CreateSection({Name = [[\\ Main //]],Side = "Left"})
local F = Genaral:CreateSection({Name = [[\\ Fighting Style //]],Side = "Left"})
local S = Genaral:CreateSection({Name = [[\\ Bosses //]],Side = "Left"})
local M = Genaral:CreateSection({Name = [[\\ Auto Farm Mastery //]],Side = "Left"})
local E = Genaral:CreateSection({Name = [[\\ Auto Elite Hunter //]],Side = "Left"})
local P = Genaral:CreateSection({Name = [[\\ Auto Pirates Raid //]],Side = "Left"})
local G = Genaral:CreateSection({Name = [[\\ Auto Soul Guitar //]],Side = "Left"})
local O = Genaral:CreateSection({Name = [[\\ Auto Farm Observation //]],Side = "Left"})
local B = Genaral:CreateSection({Name = [[\\ Settings //]],Side = "Right"})
local L = Genaral:CreateSection({Name = [[\\ Ues Skill //]],Side = "Right"})
local T = Genaral:CreateSection({Name = [[\\ Stats //]],Side = "Right"})
local K = Genaral:CreateSection({Name = [[\\ Material //]],Side = "Right"})
local H = Genaral:CreateSection({Name = [[\\ Other //]],Side = "Right"})
-------- Island --------
local TeleportWorld =  ISLAND:CreateSection({Name = [[\\ Teleport To World //]],Side = "Left"})
local Shop =  ISLAND:CreateSection({Name = [[\\ Shop //]],Side = "Left"})
local Teleport =  ISLAND:CreateSection({Name = [[\\ Teleport To IsLand //]],Side = "Right"})
...
Teleport:AddToggle({
	...
	Callback = function(v)
		...
		if statetp1 and not raidiing then
			repeat wait()
				Noclip = true
				if game:GetService("Workspace")["_WorldOrigin"].Locations[_G.Select_IsLand].Position.Y < 1 then
					totarget(game:GetService("Workspace")["_WorldOrigin"].Locations[_G.Select_IsLand].CFrame*CFrame.new(0,1000,0))
				elseif game:GetService("Workspace")["_WorldOrigin"].Locations[_G.Select_IsLand].Position.Y < 300 then
					totarget(game:GetService("Workspace")["_WorldOrigin"].Locations[_G.Select_IsLand].CFrame*CFrame.new(0,700,0))
				else
					totarget(game:GetService("Workspace")["_WorldOrigin"].Locations[_G.Select_IsLand].CFrame*CFrame.new(0,500,0))
				end
        ...
        pcall(function() 
            if _G.Settings.Auto_Farm_Level then 
                ...
                if DOINGQUEST() == false then 
                    ...
                    Fast_Attack=false 
                    if game.Players.LocalPlayer:DistanceFromCharacter(CFrameQuest.Position)<=10 then
                        if game.Players.LocalPlayer.Character.Humanoid.Health > 0 then 
                        ...
                        for i,v in pairs(game.Workspace.Enemies:GetChildren())do 
                            if _G.Settings.Auto_Farm_Level and v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then 
                                repeat wait() 
                                    ...
                                    totarget(v.HumanoidRootPart.CFrame * CFrame.new(0, 60,0)) 
                                    Fast_Attack=true 
                                    PosMon=v.HumanoidRootPart.CFrame 
                                    StartMagnet=true
                                until not _G.Settings.Auto_Farm_Level or not v.Parent or DOINGQUEST() == false or v.Humanoid.Health <= 0
                                Fast_Attack=false 
                            end 
                        end 
                    else 
        ...
        pcall(function()
            if _G.Settings.Auto_Farm_Level then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.Settings.Auto_Farm_Level and StartMagnet and v.Name == Name and (Name == "Factory Staff [Lv. 800]" or Name == "Monkey [Lv. 14]" or Name == "Dragon Crew Warrior [Lv. 1575]" or Name == "Dragon Crew Archer [Lv. 1600]" or Name == "Head Baker [Lv. 2275]" or Name == "Baking Staff [Lv. 2250]" or Name == "Cake Guard [Lv. 2225]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                        ...
                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                    elseif _G.Settings.Auto_Farm_Level and StartMagnet and v.Name == Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 375 then
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                        v.Head.CanCollide = false
...
if game.PlaceId==tonumber(4442272183)or game.PlaceId==tonumber(7449423635)then 
	A:AddToggle({
		Name="Auto Third Word", 
		Value=_G.Settings.Auto_Third_World, 
		Callback=function(v)
			_G.Settings.Auto_Third_World = v 
			s() 
		end
	}) 
elseif game.PlaceId==tonumber(2753915549)then 
	A:AddToggle({
		Name="Auto New World", 
		Value=_G.Settings.Auto_New_World, 
		Callback=function(v)
			_G.Settings.Auto_New_World = v 
			s() 
		end
	})  
end
...
F:AddToggle({
    ...
    Callback=function(v)
        _G.Settings.Auto_Superhuman = v
        s()
    end
})
F:AddToggle({
    Name = "Auto Deth Step",
    Value=_G.Settings.Auto_DethStep,
    Callback=function(v)
        _G.Settings.Auto_DethStep = v
        s()
    end
})
F:AddToggle({
    Name = "Auto Sharkman Karata",
    Value=_G.Settings.Auto_Sharkman_Karata,
    Callback=function(v)
        _G.Settings.Auto_Sharkman_Karata = v
        s()
    end
})
F:AddToggle({
    ...
    Callback=function(v)
        _G.Settings.Auto_Dragon_Talon = v
        s()
    end
})
F:AddToggle({
    ...
    Callback=function(v)
        _G.Settings.Auto_God_Human = v
        s()
    end
})
M:AddToggle({
    Name = "Auto Farm Mastery DF",
    Value = _G.Settings.Auto_Farm_Mastery_DF,
    Callback = function(v)
        _G.Settings.Auto_Farm_Mastery_DF = v
        s()
    end
})
M:AddToggle({
    ...
    Callback = function(v)
        _G.Settings.Auto_Farm_Mastery_Gun = v
        s()
    end
})
M:AddSlider({
    Name = "X At",
    Value = _G.Settings.X_At,
    Min = 1,
    Max = 100,
    Format = function(value)
		_G.Settings.X_At = value
		s()
		return "X At : " .. tostring(value)
    end
})
M:AddSlider({
    Name = "Y At",
    Value = _G.Settings.Y_At,
    Min = 1,
    Max = 100,
    Format = function(value)
		_G.Settings.Y_At = value
		s()
		return "Y At : " .. tostring(value)
    end
})
M:AddSlider({
    Name = "Z At",
    Value = _G.Settings.Z_At,
    Min = 1,
    Max = 100,
    Format = function(value)
		_G.Settings.Z_At = value
		s()
		return "Z At : " .. tostring(value)
    end
})

M:AddSlider({
    Name = "Health At",
    Value = _G.Settings.Health_Mods,
    Min = 1,
    Max = 100,
    Format = function(value)
		_G.Settings.Health_Mods = value
		s()
		return "Health At : " .. tostring(value)
    end
})
...
task.spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.Auto_Farm_Mastery_DF then
				CheckQuest()
				if game:GetService("Workspace").Enemies:FindFirstChild(Name) then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							repeat wait()
								HealthMin = v.Humanoid.MaxHealth*_G.Settings.Health_Mods/100
								if v.Humanoid.Health <= HealthMin and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
									...
									totarget(v.HumanoidRootPart.CFrame * CFrame.new(_G.Settings.X_At,_G.Settings.Y_At,_G.Settings.Z_At))
									...
									if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") then
										if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) then
											Mastery = require(game:GetService("Players").LocalPlayer.Character[game.Players.LocalPlayer.Data.DevilFruit.Value].Data)
										...
										elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) then
											Mastery = require(game:GetService("Players").LocalPlayer.Backpack[game.Players.LocalPlayer.Data.DevilFruit.Value].Data)
										...
										if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon-Dragon") then
											if _G.Settings.Skill_Z and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and DevilFruitMastery >= Mastery.Lvl.Z then
												game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
												wait(.1)
												game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
											end
											if _G.Settings.Skill_X and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and DevilFruitMastery >= Mastery.Lvl.X then
												game:service('VirtualInputManager'):SendKeyEvent(true, "X", false, game)
												wait(.1)
												game:service('VirtualInputManager'):SendKeyEvent(false, "X", false, game)
											end   
										elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Human-Human: Buddha") then
											if _G.Settings.Skill_Z and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and game.Players.LocalPlayer.Character.HumanoidRootPart.Size == Vector3.new(7.6, 7.676, 3.686) and DevilFruitMastery >= Mastery.Lvl.Z then
											else
												game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
												wait(.1)
												game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
											...
											if _G.Settings.Skill_C and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and DevilFruitMastery >= Mastery.Lvl.C then
										...
										elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild(game.Players.LocalPlayer.Data.DevilFruit.Value) then
											...
											if _G.Settings.Skill_V and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and DevilFruitMastery >= Mastery.Lvl.V then
												game:service('VirtualInputManager'):SendKeyEvent(true, "V", false, game)
												wait(.1)
												game:service('VirtualInputManager'):SendKeyEvent(false, "V", false, game)
											end
							...
							until not game:GetService("Workspace").Enemies:FindFirstChild(Name) or not _G.Settings.Auto_Farm_Mastery_DF or v.Humanoid.Health <= 0 or not v.Parent
						end
					end
				else
					totarget(CFrameMon)
				...
				if game:GetService("Workspace").Enemies:FindFirstChild(Name) then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							...
							until not game:GetService("Workspace").Enemies:FindFirstChild(Name) or not _G.Settings.Auto_Farm_Mastery_Gun or v.Humanoid.Health <= 0 or not v.Parent
						end
					end
				else
					totarget(CFrameMon)
...
task.spawn(function()
    while task.wait() do
        pcall(function()
			CheckQuest()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Settings.Auto_Farm_Mastery_DF and StartMasteryFruitMagnet then
					if v.Name == Name then
				...
				if  _G.Settings.Auto_Farm_Mastery_Gun and StartMasteryGunMagnet then
				...
				if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
					if UseSkillMasteryDevilFruit then
						if type(args[2]) == "vector" then 
							...
							args[2] = CFrame.new(PosMonMasteryFruit)
						end
						return old(unpack(args))
					end
				end
...
local Spawned=E:AddLabel({
    Name = "Elite Spawn : False"
})
local KILL_ELITE=E:AddLabel({
    Name = "Elite Kill : 0"
})
spawn(function()
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
                Spawned:Set("Status : True")	
            else
                Spawned:Set("Status : False")	
            end
        end)
    end
end)
spawn(function()
    while wait() do
        KILL_ELITE:Set("Elite Kill : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
    end
end)
E:AddToggle({
    ...
    Callback=function(v)
        _G.Settings.Auto_Elite_Hunter =v 
    end
})
E:AddToggle({
    ...
    Callback=function(v)
        _G.Settings.Auto_Elite_Hunter_Hop =v 
    end
})
spawn(function()
    while wait() do
        if _G.Settings.Auto_Elite_Hunter and World3 then
            pcall(function()
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                                ...
                                if v.Name == "Diablo [Lv. 1750]" or v.Name == "Deandre [Lv. 1750]" or v.Name == "Urban [Lv. 1750]" then
                                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                        repeat wait()
                                            ...
                                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                        until _G.Settings.Auto_Elite_Hunter == false or v.Humanoid.Health <= 0 or not v.Parent
                                    end
                                end
                            end
                        else
                    ...
                    if _G.Settings.Auto_Elite_Hunter_Hop and game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("EliteHunter") == "I don't have anything for you right now. Come back later." then
                        Hop()
                    else
...
P:AddToggle({
    ...
    Value = _G.Settings.Auto_Pirates_Raid,
    Callback = function(v)
        _G.Settings.Auto_Pirates_Raid = v
        s()
    end
})
task.spawn(function()
    while task.wait(.1) do
        pcall(function()
            if _G.Settings.Auto_Pirates_Raid then
                if game.Players.LocalPlayer:DistanceFromCharacter(CFrame.new(-5500.93066, 313.765503, -2913.98389, 0.966521382, -8.55035509e-09, 0.256586045, 4.56777505e-09, 1, 1.61174114e-08, -0.256586045, -1.44057966e-08, 0.966521382).Position) <= 500 then
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                            repeat wait()
                                ...
                                EquipWeapon(_G.Settings.Select_Weapon)
                                totarget(v.HumanoidRootPart.CFrame * CFrame.new(0,30,0))
                            until not _G.Settings.Auto_Pirates_Raid or not v.Parent or v.Humanoid.Health <= 0
                            Fast_Attack=false
                        end
                    end
                else
                    totarget(CFrame.new(-5500.93066, 313.765503, -2913.98389, 0.966521382, -8.55035509e-09, 0.256586045, 4.56777505e-09, 1, 1.61174114e-08, -0.256586045, -1.44057966e-08, 0.966521382))
                end
            end
        end)
    end 
...
G:AddToggle({
    Name = "Find Full Moon [require hop]",
    Value = _G.Settings.Disabled_Hop,
    Callback = function(value)
        _G.Settings.Find_Full_Moon = value
        s()
    end
})

local function Check_Weapon(name)
	local args = {[1] = "getInventory"}
	a=game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
local function Check_Material(name)
	local args = {[1] = "getInventory"}
	a=game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
	for i,v in pairs(a)do
...
-- 	while task.wait(.1) do
-- 		pcall(function()
-- 			if _G.Settings.Auto_Soul_Guitar then
-- 				if Check_Weapon("Soul Guitar") then
-- 				elseif Check_Material("Ectoplasm") >= 250 and Check_Material("Dark Fragment") >= 1 and Check_Material("Bones") >= 500 then
-- 					if tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("gravestoneEvent",2):find("come back during night")) or tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("gravestoneEvent",2):find("Error")) then
-- 						if _G.Settings.Find_Full_Moon then
-- 							Hop()
-- 						else
-- 							totarget(CFrame.new(-8654.72363, 140.94986, 6167.99414, -0.985216379, 7.5973503e-08, -0.171314418, 7.26761868e-08, 1, 2.55187285e-08, 0.171314418, 1.26909914e-08, -0.985216379))
-- 						end
-- 					else
...
-- 											v.HumanoidRootPart.CFrame = CFrame.new(-10160.787109375, 138.6616973876953, 5955.03076171875)
-- 											totarget(v.HumanoidRootPart.CFrame * CFrame.new(0,30,0))
-- 											game:GetService'VirtualUser':CaptureController()
-- 											game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
-- 										end
...
-- 					end
-- 				else
-- 					if Check_Material("Ectoplasm") <= 250 then
-- 						if World2 then
...
-- 											until not _G.Settings.Auto_Soul_Guitar or not v.Parent or v.Humanoid.Health <= 0
-- 										end
-- 									end
-- 								end
-- 							else
...
-- 											v.HumanoidRootPart.Size = Vector3.new(60,60,60)
-- 											totarget(v.HumanoidRootPart.CFrame * CFrame.new(0,20,0))
-- 										until _G.Settings.Auto_Soul_Guitar or v.Humanoid.Health <= 0
-- 									end
-- 								end
-- 							else
...
-- 							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
-- 						end
-- 					elseif Check_Material("Bones") <= 500 then
-- 						if World3 then
...
-- 												v.HumanoidRootPart.Size = Vector3.new(60,60,60)
-- 												totarget(v.HumanoidRootPart.CFrame * CFrame.new(0,20,0))
-- 											until not _G.Settings.Auto_Soul_Guitar or v.Humanoid.Health <= 0 or not v.Parent or v.Humanoid.Health <= 0
-- 											fasfasfas = false
-- 											FastAttack = false
-- 										end
-- 									end
...
task.spawn(function() 
	while wait() do 
		pcall(function() 
			...
			Observation:Set("Observation Haki Level : "..tostring(Value)) 
		end) 
	end 
end)
O:AddToggle({
	Name = "Auto Farm Observation",
	Value = _G.Settings.Auto_Farm_Observation,
	Callback = function(v)
		_G.Settings.Auto_Farm_Observation = v
		s()
	end
})
O:AddToggle({
	Name = "Auto Farm Observation Hop",
	Value = _G.Settings.Auto_Farm_Observation_Hop,
	Callback = function(v)
		_G.Settings.Auto_Farm_Observation_Hop = v
		s()
	end
})
function Check_Mon()
	if World1 then
		Mods = "Military Spy [Lv. 325]"
		PosMon = CFrame.new(-5531.7568359375, 8.983367919921875, 8450.1748046875)
	elseif World2 then
		Mods = "Marine Captain [Lv. 900]"
		PosMon = CFrame.new(-1936.3089599609375, 112.49726104736328, -3069.9794921875)
	elseif World3 then
		Mods = "Living Zombie [Lv. 2000]"
		PosMon = CFrame.new(-10011.3359375, 250.45449829101562, 5918.9970703125)
	end
end
task.spawn(function()
	while wait(0.1) do
		pcall(function()
			if _G.Settings.Auto_Farm_Observation then
				Check_Mon()
				if World3 then
					if not game.Workspace:FindFirstChild(Mods) then
						wait(totarget(PosMon))
					end
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
						if v.Name == Mods then
							repeat wait(.1)
								...
								wait(totarget(v.HumanoidRootPart.CFrame * CFrame.new(1,0,0)))
								local Humanoid = game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Humanoid")
								Humanoid:GetPropertyChangedSignal("Health"):Connect(function()
									if _G.Settings.Auto_Farm_Observation_Hop then
							...
							until v.Humanoid.Health <= 0 or not _G.Settings.Auto_Farm_Observation
						end
					end	
				end
			end
...
S:AddDropdown({Name="Select Boss",List=Boss,Callback=function(J)
    _G.Settings.Select_Boss=J;
    s();
end});
S:AddToggle({
    Name = "Auto Farm Boss",
    ...
    Callback=function(v)
        _G.Settings.Auto_Farm_Boss = v
        s()
    end
})
S:AddToggle({
    Name = "Auto Farm Boss Hop",
    Value = _G.Settings.Auto_Farm_Boss_Hop,
    Callback=function(v)
        _G.Settings.Auto_Farm_Boss_Hop = v
        s()
    end
})
task.spawn(function()
    while wait() do
        pcall(function()
            if _G.Settings.Auto_Farm_Boss then
                n=true;
				for a,GU in pairs(game.ReplicatedStorage:GetChildren())do 
					if _G.Settings.Select_Boss[tostring(GU)] ~=nil then 
						n=false;
					end;
				end;
				for a,Bg in pairs(game.ReplicatedStorage:GetChildren())do 
					if _G.Settings.Select_Boss[tostring(Bg)] ~=nil then 
						n=false;
					end;
				end;
				if n==true then 
					if _G.Settings.Auto_Farm_Boss_Hop then 
						Hop();
					end;
				end;
				for a,SZ in pairs(game.ReplicatedStorage:GetChildren()) do 
					if _G.Settings.Select_Boss == SZ.Name then 
						repeat wait();
                            Fast_Attack = true
							if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
								local args = {
                            ...
                            totarget(SZ.HumanoidRootPart.CFrame*CFrame.new(0,30,0))
							EquipWeapon(_G.Settings.Select_Weapon)
						until not SZ:FindFirstChild("HumanoidRootPart")or not SZ:FindFirstChild("Humanoid")or SZ:FindFirstChild("Humanoid").Health<=0 or not _G.Settings.Auto_Farm_Boss;
                        Fast_Attack = false
					end;
				end;
            end
...
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    if v:IsA("Tool") then  
        table.insert(Weapon_List, v.Name)
    end
end
for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
    if v:IsA("Tool") then
	...
	for i = 1, 1 do
		...
		if #bladehit > 0 then
			...
			if plr.Character:FindFirstChildOfClass("Tool") and AC.blades and AC.blades[1] then 
				...
				game:GetService("ReplicatedStorage"):WaitForChild('RigControllerEvent'):FireServer("weaponChange", tostring(GetCurrentBlade()))
			end
		end
    end
end
...
All_Stats = {"Melee", "Defense","Sword", "Blox Fruit"}
T:AddDropDown({
	Name = "Select Stats",
	Multiple=true,
	List = All_Stats,
	Value = _G.Settings.Selected_Stats,
	Callback = function(v)
		_G.Settings.Selected_Stats = v
		s()
	end
})
T:AddToggle({
...
task.spawn(function()
	...
	while true do wait()
		if _G.Settings.Auto_Stats then 
			for R,X in pairs(_G.Settings.Selected_Stats)do 
...
K:AddToggle({
	...
	Value = _G.Settings.Auto_Farm_Material,
	Callback = function(v1)
		_G.Settings.Auto_Farm_Material = v1
		s()
	end
})
...
task.spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.Auto_Farm_Material then
				CheckMaterial(_G.Settings.Select_Material);
				if CustomFindFirstChild(MaterialMob) then
					for v0,v1 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
						if (_G.Settings.Auto_Farm_Material and table.find(MaterialMob,v1.Name) and v1:FindFirstChild("HumanoidRootPart") and v1:FindFirstChild("Humanoid") and (v1.Humanoid.Health>0)) then 
							repeat wait();
								totarget(v1.HumanoidRootPart.CFrame * CFrame.new(0,30,1));
								if (v1:FindFirstChild("HumanoidRootPart") and v1:FindFirstChild("Humanoid") and ((v1.HumanoidRootPart.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude<=150)) then 
									...
									BringMobs(v1.HumanoidRootPart.CFrame, v1.Name)
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v1.HumanoidRootPart.CFrame * CFrame.new(0,30,1);
								end 
							until not CustomFindFirstChild(MaterialMob) or not _G.Settings.Auto_Farm_Material or (v1.Humanoid.Health<=0) or not v1.Parent 
							Fast_Attack=false;
						end 
					end 
				else 
...
H:AddToggle({
	...
	Value = _G.Settings.Auto_Farm_Bones,
	Callback = function(v)
		_G.Settings.Auto_Farm_Bones = v
	end
})
function Bones()
	pcall(function()
		if _G.Settings.Auto_Farm_Bones and not raidiing and World3 then
			...
			if (heuantedcalstle.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1500 then
				if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton [Lv. 1975]") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie [Lv. 2000]") or  game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul [Lv. 2025]") or  game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy [Lv. 2050]") then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]" or v.Humanoid.Health > 0 then
							repeat wait()
								if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
									local args = {
										[1] = "Buso"
								...
								EquipWeapon(_G.Settings.Select_Weapon)
								totarget(v.HumanoidRootPart.CFrame * CFrame.new(0 , 30 , 0))--CFrame.new(7 , 30 , 20))
								StartBoneMagnet=true
							until not v.Parent or v.Humanoid.Health <= 0 or _G.Settings.Auto_Farm_Bones == false or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or raidiing
							Fast_Attack = false
						end
					end
				else
					if (heuantedcalstle.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 500 then
						repeat wait()
							totarget(heuantedcalstle)
						until _G.Settings.Auto_Farm_Bones == false or x:DistanceFromCharacter(heuantedcalstle.Position) <= 10
					end
				end
			else
			    totarget(heuantedcalstle)
...
task.spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.Auto_Farm_Bones then
				Bones()
			end
		end)
	end
...
task.spawn(function()
    while task.wait() do
        pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Settings.Auto_Farm_Bones and StartBoneMagnet then
					if (v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]") and (v.HumanoidRootPart.Position - MainMonBone.Position).Magnitude <= 225 then
						v.Head.CanCollide = false
						v.HumanoidRootPart.CanCollide = false
...
H:AddToggle({
	Name = "Auto Finish Quest Dough",
	Value = _G.Settings.Auto_Quest_Dough,
	Callback = function(v)
		_G.Settings.Auto_Quest_Dough = v
	end
})
function Quest_Dough()
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do  
					if (v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Cookie Crafter [Lv. 2200]") and v.Humanoid.Health > 0 then
						repeat wait()
							...
							game:GetService'VirtualUser':CaptureController()
							game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
						until _G.Settings.Auto_Quest_Dough == false or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or not v.Parent or v.Humanoid.Health <= 0
					end
				end
			else
			...
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
				if v.Name == "Dough King [Lv. 2300] [Raid Boss]" then
					repeat wait()
						...
						game:GetService'VirtualUser':CaptureController()
						game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
					until _G.Settings.Auto_Quest_Dough == false or not v.Parent or v.Humanoid.Health <= 0
				end    
			end    
		else
						...
						if v.Name == "Diablo [Lv. 1750]" or v.Name == "Deandre [Lv. 1750]" or v.Name == "Urban [Lv. 1750]" then
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								repeat wait()
									...
									game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
									sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
								until _G.Settings.Auto_Quest_Dough == false or v.Humanoid.Health <= 0 or not v.Parent or game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice")
							end
						end
					end
				else
					if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") then
						totarget(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,30,0))
					elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") then
						totarget(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,30,0))
					elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") then
						totarget(game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]").HumanoidRootPart.CFrame * CFrame.new(0,20,0))
					end
				end                    
			end
		else
...
task.spawn(function()
	while wait() do
		pcall(function()
			if _G.Settings.Auto_Quest_Dough then
				Quest_Dough()
			end
		end)
	end
...
spawn(function()
	game:GetService("RunService").Heartbeat:Connect(function()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Settings.Auto_Quest_Dough and StartCakeMagnet and (v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]") and (v.HumanoidRootPart.Position - Cakepos.Position).magnitude <= 350 then
...
H:AddToggle({
	...
	Callback = function(v)
		_G.Settings.Auto_Holy_Torch = v
	end
})
spawn(function()
	while wait() do
		if _G.Settings.Auto_Holy_Torch then
			pcall(function()
				wait(1)
				repeat totarget(CFrame.new(-10752, 417, -9366)) wait() until not _G.Settings.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-10752, 417, -9366)).Magnitude <= 10
				wait(1)
				repeat totarget(CFrame.new(-11672, 334, -9474)) wait() until not _G.Settings.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-11672, 334, -9474)).Magnitude <= 10
				wait(1)
				repeat totarget(CFrame.new(-12132, 521, -10655)) wait() until not _G.Settings.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-12132, 521, -10655)).Magnitude <= 10
				wait(1)
				repeat totarget(CFrame.new(-13336, 486, -6985)) wait() until not _G.Settings.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13336, 486, -6985)).Magnitude <= 10
				wait(1)
				repeat totarget(CFrame.new(-13489, 332, -7925)) wait() until not _G.Settings.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13489, 332, -7925)).Magnitude <= 10
			end)
		end
	end
end)
...
H:AddToggle({
	...
	Callback = function(v)
		_G.Settings.Auto_Farm_Ectoplasm = v
	end
})
spawn(function()
	while wait() do
		if _G.Settings.Auto_Farm_Ectoplasm then
			pcall(function()
					...
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if string.find(v.Name, "Ship") then
							repeat wait()
								...
								game:GetService'VirtualUser':CaptureController()
								game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
							until _G.Settings.Auto_Farm_Ectoplasm == false or not v.Parent or v.Humanoid.Health <= 0
...
spawn(function()
	game:GetService("RunService").Heartbeat:Connect(function()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Settings.Auto_Farm_Ectoplasm and MagnetEctoplasm and string.find(v.Name, "Ship") and (v.HumanoidRootPart.Position - PosMonEctoplasm.Position).magnitude <= 300 then
...
H:AddToggle({
	...
	Callback = function(v)
		_G.Settings.Auto_Factory_Farm = v
	end
})
spawn(function()
	while wait() do
		if _G.Settings.Auto_Factory_Farm then
			pcall(function()
					...
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
						if _G.FactoryCore and v.Name == "Core" and v.Humanoid.Health > 0 then
							repeat wait()
								...
								game:GetService'VirtualUser':CaptureController()
								game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
							until not _G.FactoryCore or v.Humanoid.Health <= 0 or _G.Settings.Auto_Factory_Farm == false
						end
					end
...
pcall(function()
	for i, v in pairs(game:GetService("CoreGui").PepsiUi.main:GetDescendants()) do 
